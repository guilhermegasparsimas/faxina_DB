...
const createUser = async (req, res) => {
    ...
    try {
        ...
        const [result] = await db.query("INSERT INTO usuario (nome, cpf, email, password_hash, tipo_usuario) VALUES (?, ?, ?, ?, ?)", [nome, cpf, email, hashPassword, tipo_usuario, 1]);
...
const getUser = async (req, res) => {
    try {
        const [resultado] = await db.query("SELECT  nome, cpf, email, tipo_usuario FROM usuario ");
